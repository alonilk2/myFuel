...
public class IncomeReportController implements Initializable {
	//Controllers
		...
		@FXML
		private TableColumn<FuelType, Double> income;
		@FXML 
		...
		public void setTableDataFromDB(List<FuelType> list) {
			...
			income.setCellValueFactory(new PropertyValueFactory<FuelType,Double>("quantity"));
		    tableview.setItems(olist);
		}

		public IncomeReportController(ClientController client) {
			this.client = client;
		}
