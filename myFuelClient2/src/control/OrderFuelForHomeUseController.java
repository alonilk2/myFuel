...
public class OrderFuelForHomeUseController implements Initializable {
	...
	private void onConfirmClick(ActionEvent event){
		try {
			...
			HomeFuelOrder newOrder = new HomeFuelOrder(sum, fueltype, qty, orderDate, OrderStatus.Preparing, deliveryDate, addr, fastSupply, client.getCustomer().getCustomerID());
